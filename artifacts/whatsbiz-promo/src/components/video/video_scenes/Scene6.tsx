  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        >
          <p className="text-[1.6vw] text-[#94A3B8]" style={{ fontFamily: 'var(--font-body)' }}>
            Join thousands of Indian businesses growing with AI
          </p>
        </motion.div>

        <motion.div
          className="px-[3.5vw] py-[1.2vh] rounded-full border border-[#25D366]/50 bg-[#25D366]/12 backdrop-blur-sm"
          initial={{ opacity: 0, scale: 0.9 }}
          animate={phase >= 5 ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
          transition={{ type: 'spring', stiffness: 300, damping: 20 }}
        >
          <span className="text-[1.3vw] text-[#25D366] font-semibold" style={{ fontFamily: 'var(--font-body)' }}>
            Start Free Today — whatsbiz.ai
          </span>
        </motion.div>
      </div>
