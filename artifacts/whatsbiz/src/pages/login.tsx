    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative flex items-center gap-3">
          <img src="/icon.png" alt="WhatsBiz AI" className="h-20 w-20 object-contain" style={{ filter: "brightness(0) invert(1) drop-shadow(0 2px 8px rgba(0,0,0,0.3))" }} />
          <div>
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(145deg, #075E54 0%, #128C7E 45%, #25D366 100%)" }}
        >
          <img src="/icon.png" alt="WhatsBiz AI" className="h-20 w-20 sm:h-24 sm:w-24 object-contain shrink-0" style={{ filter: "brightness(0) invert(1) drop-shadow(0 2px 10px rgba(0,0,0,0.3))" }} />
          <div>
